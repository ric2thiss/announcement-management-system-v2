                    ...
                    <form id="myForm">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" id="what" class="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Enter the 'What'">
                            </div>
                            
                            <div class="flex flex-col">
                                <label for="who" class="mb-2 font-medium text-gray-700">Who:</label>
                                <input type="text" id="who" class="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Enter the 'Who'">
                            </div>
                            
                            <div class="flex flex-col">
                                <label for="where" class="mb-2 font-medium text-gray-700">Where:</label>
                                <input type="text" id="where" class="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Enter the 'Where'">
                            </div>
                            
                            <div class="flex flex-col">
                                <label for="when" class="mb-2 font-medium text-gray-700">When:</label>
                                <input type="text" id="when" class="p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="Enter the 'When'">
                            </div>
                        </div>
