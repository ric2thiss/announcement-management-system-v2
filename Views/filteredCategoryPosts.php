...
<body class="bg-gray-100">
    ...
    <main class="flex">
        ...
        <aside class="w-16 bg-gray-900 text-white flex flex-col items-center space-y-6 py-6 sticky top-14 h-screen">
            ...
            <a href=".../<?=$userData["photo"]?>" class="text-gray-500"><i class="fa-solid fa-user text-xl"></i></a>
        </aside>
                ...
                <div class="bg-white p-6 rounded-lg shadow sticky top-24">
                    ...
                    <div class="space-y-2">
                        <p class="bg-gray-100 p-4 rounded-lg flex justify-between">
                            All Announcement <span><?=count($filteredPosts)?></span>
                        </p>
                        <?php
                        $unique_category = array_unique(array_column($filteredPosts, 'category_name'));
                        ?>
                        <?php foreach($unique_category as $category_name): ?>
                            <p class="p-2 hover:bg-gray-100 p-4 rounded-lg flex justify-between"><?=$category_name?></p>
                        <?php endforeach; ?>
                    </div>
                </div>
            </div>
